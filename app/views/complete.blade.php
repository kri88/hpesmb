...
<header id="side">
    ...
    <h2 class="blue big">{{$heading}}</h2>
    <p class="result">{{$sub1}}</p>
...
<section id="page">
    ...
    {{ Form::open(array('url' => '/quiz/complete','id'=>'form-email-report','class'=>'clearfix')) }}
        <fieldset>
            ...
            <button class="btn btn-lg btn-primary pull-right {{$btnclass}}" type="submit"><i class="icon-email"></i> {{Lang::get('general.emailreport')}}</button>
        </fieldset>
    {{ Form::close() }}
</section>
@stop
